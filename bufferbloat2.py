...
class BBTopo(Topo):
    ...
    def build(self, n=2):
        ...
        loss_link = {"delay": "{}ms".format(args.delay), "max_queue_size": args.maxq, "loss":0.5}
...
def start_iperf(net):
    ...
    client = h1.popen("iperf -c {} -t {} -P 10 > {}/iperf_client.txt".format(h2.IP(), args.time, args.dir), shell=True)
